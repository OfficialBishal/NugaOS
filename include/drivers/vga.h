...
#ifndef __NUGAOS__DRIVERS__VGA_H
#define __NUGAOS__DRIVERS__VGA_H
...
namespace nugaos
{
    namespace drivers
    {
        ...
        protected:
            ...
            void WriteRegisters(common::uint8_t* registers);    //send data to ports
            common::uint8_t* GetFrameBufferSegment();   //get frame buffer memory offset
