...
#ifndef __NUGAOS__DRIVERS__AMD_AM79C973_H
#define __NUGAOS__DRIVERS__AMD_AM79C973_H
...
namespace nugaos
{
    namespace drivers
    {
        ...
        public:
            amd_am79c973(nugaos::hardwarecommunication::PeripheralComponentInterconnectDeviceDescriptor *dev,
                         nugaos::hardwarecommunication::InterruptManager* interrupts);
            ~amd_am79c973();
